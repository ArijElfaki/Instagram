...
- [X] Custom action bar 
- [X] Profile shows posts made by that user
- [X] Users have a bio they can edit

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Keeping variable names straight in a complex app
2. Nested layouts
...
<img src='http://recordit.co/B8knen1nym' title='Video Walkthrough' width='' alt='Video Walkthrough' />
